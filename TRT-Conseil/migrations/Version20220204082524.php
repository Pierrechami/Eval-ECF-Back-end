 ...
 */
final class Version20220204082524 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job DROP recruiter_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type_contrat type_contrat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
