 ...
 */
final class Version20220211082045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job DROP INDEX IDX_FBD8E0F8156BE243, ADD UNIQUE INDEX UNIQ_FBD8E0F8156BE243 (recruiter_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job DROP INDEX UNIQ_FBD8E0F8156BE243, ADD INDEX IDX_FBD8E0F8156BE243 (recruiter_id)');
