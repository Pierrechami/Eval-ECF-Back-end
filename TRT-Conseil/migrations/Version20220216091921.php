 ...
 */
final class Version20220216091921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job ADD place VARCHAR(255) NOT NULL, ADD description LONGTEXT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE job_recruiter (job_id INT NOT NULL, recruiter_id INT NOT NULL, INDEX IDX_1936DCC9BE04EA9 (job_id), INDEX IDX_1936DCC9156BE243 (recruiter_id), PRIMARY KEY(job_id, recruiter_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE job DROP place, DROP description, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type_contrat type_contrat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
