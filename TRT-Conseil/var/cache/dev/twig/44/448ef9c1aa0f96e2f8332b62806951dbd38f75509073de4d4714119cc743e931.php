...
class __TwigTemplate_1ca5fcbf617921861d42a517520775deb0821049b58e689c3fa9574bd5526a93 extends Template
{
    private $source;
    private $macros = [];
   ...
   ";
    ...
    <p><strong>Accepter l'utilisateur</strong> : ";
        // line 5
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 5, $this->source); })()), "is_accepted", [], "any", false, false, false, 5), 'widget');
        echo " </p>
</div>
<button class=\"btn\">";
        // line 7
...
";
    ...
    {
        return array (  63 => 8,  59 => 7,  54 => 5,  50 => 4,  47 => 3,  43 => 1,);
    }
...
", "user/_form.html.twig", "/Users/ChaminadePierre/Documents/Back-office/ECF-back-end/Eval-ECF-Back-end/TRT-Conseil/templates/user/_form.html.twig");
    }
}
