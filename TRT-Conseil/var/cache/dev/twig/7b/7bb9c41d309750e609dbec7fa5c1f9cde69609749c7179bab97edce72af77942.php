...
/* job/show.html.twig */
class __TwigTemplate_1c655fbeb110bfc3a5702c2e440175e2b334c5cc8a31663a3993c46a1bc95223 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        <tr>
            ...
            <td>";
        // line 33
        ((twig_get_attribute($this->env, $this->source, (isset($context["job"]) || array_key_exists("job", $context) ? $context["job"] : (function () { throw new RuntimeError('Variable "job" does not exist.', 33, $this->source); })()), "endDate", [], "any", false, false, false, 33)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["job"]) || array_key_exists("job", $context) ? $context["job"] : (function () { throw new RuntimeError('Variable "job" does not exist.', 33, $this->source); })()), "endDate", [], "any", false, false, false, 33), "Y-m-d"), "html", null, true))) : (print ("Pas de date de fin de contrat")));
        echo "</td>
        </tr>
        <tr>
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        <tr>
            <th>Date de fin</th>
            <td>{{ job.endDate ? job.endDate|date('Y-m-d') : 'Pas de date de fin de contrat' }}</td>
        </tr>
        <tr>
            <th>Nombre d'heures semaine</th>
            <td>{{ job.time }}</td>
