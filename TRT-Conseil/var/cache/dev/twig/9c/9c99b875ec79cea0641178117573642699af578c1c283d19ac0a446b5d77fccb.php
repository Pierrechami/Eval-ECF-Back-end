...
class __TwigTemplate_aebd1603436d0c63955ed571e2e02b7fc594870c0b129ff89be8c950bb52bd1f extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["recruiter"]) || array_key_exists("recruiter", $context) ? $context["recruiter"] : (function () { throw new RuntimeError('Variable "recruiter" does not exist.', 12, $this->source); })()), "companieName", [], "any", false, false, false, 12), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["recruiter"]) || array_key_exists("recruiter", $context) ? $context["recruiter"] : (function () { throw new RuntimeError('Variable "recruiter" does not exist.', 16, $this->source); })()), "address", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  111 => 21,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('recruiter_edit', {'id': recruiter.id}) }}\">Modifier mes informations</a>

{% endblock %}
", "recruiter/show.html.twig", "/Users/ChaminadePierre/Documents/Back-office/ECF-back-end/Eval-ECF-Back-end/TRT-Conseil/templates/recruiter/show.html.twig");
    }
}
