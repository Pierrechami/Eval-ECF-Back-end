...
class getForm_RegistryService extends App_KernelEnvDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\CandidateJobType' => ['privates', 'App\\Form\\CandidateJobType', 'getCandidateJobTypeService', true],
            'App\\Form\\CandidateType' => ['privates', 'App\\Form\\CandidateType', 'getCandidateTypeService', true],
            'App\\Form\\ConsultantType' => ['privates', 'App\\Form\\ConsultantType', 'getConsultantTypeService', true],
            'App\\Form\\JobConsultantType' => ['privates', 'App\\Form\\JobConsultantType', 'getJobConsultantTypeService', true],
            'App\\Form\\JobType' => ['privates', 'App\\Form\\JobType', 'getJobTypeService', true],
            'App\\Form\\RecruiterType' => ['privates', 'App\\Form\\RecruiterType', 'getRecruiterTypeService', true],
            'App\\Form\\RegistrationConsultantType' => ['privates', 'App\\Form\\RegistrationConsultantType', 'getRegistrationConsultantTypeService', true],
            ...
            'App\\Form\\CandidateJobType' => '?',
            'App\\Form\\CandidateType' => '?',
            'App\\Form\\ConsultantType' => '?',
            'App\\Form\\JobConsultantType' => '?',
            'App\\Form\\JobType' => '?',
            'App\\Form\\RecruiterType' => '?',
            'App\\Form\\RegistrationConsultantType' => '?',
