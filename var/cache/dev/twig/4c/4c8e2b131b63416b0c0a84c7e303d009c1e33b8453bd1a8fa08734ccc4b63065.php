...
/* user/show.html.twig */
class __TwigTemplate_6f2aaaf879adb1350cd439eb8a9e83b60a21dbe2063fee5e3ad0653dcb2348da extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 29
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 29, $this->source); })()), "isAccepted", [], "any", false, false, false, 29)) ? ("Yes") : ("No"));
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "/Users/ChaminadePierre/Documents/Back-office/ECF-back-end/Eval-ECF-Back-end/TRT-Conseil/templates/user/show.html.twig");
    }
}
