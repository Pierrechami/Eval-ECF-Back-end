...
class __TwigTemplate_6d23f6af5ba3aecd043147c03d668d62a8c468ba287a44d7ef6d5a60a53eb000 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["job"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["candidate"]) {
                ...
                echo "\">Approuver la démarche</a></td>
                </tr>
            ";
            }
        ...
        {% for job in jobs %}
            {% for candidate in job.candidates %}
                <tr>
                    ...
                    <td>{{ job.title }}</td>
                 <td><a href=\"{{ path('approving_candidate_job_edit', {'id': job.id , 'cid' : candidate.id}) }}\">Approuver la démarche</a></td>
                </tr>
            {% endfor %}
        {% endfor %}
        </tbody>
